...
export const EXPERIENCE_TECH_ICONS: Record<ExperienceTechCategory, ExperienceTechIconConfig[]> = {
  ...
  backendCloud: [
    ...
    },
    {
      ...
      iconLight: '/assets/icons/tech/directus/directus_logo.svg',
      width: 28,
      showText: true,
    },
    {
      ...
      iconLight: '/assets/icons/tech/postgresql/postgresql_logo.svg',
      width: 28,
      showText: true,
    },
  ],
  developmentTools: [
    ...
    },
    {
      ...
      iconLight: '/assets/icons/tech/jira/jira_logo.svg',
      width: 28,
      showText: true,
    },
    {
      ...
      iconLight: '/assets/icons/tech/confluence/confluence_logo.svg',
      width: 28,
      showText: true,
    },
  ],
  deployment: [
    ...
    },
    {
      ...
      iconLight: '/assets/icons/tech/resend/resend_logo_light.svg',
      iconDark: '/assets/icons/tech/resend/resend_logo_dark.svg',
      width: 28,
      showText: true,
    },
    {
