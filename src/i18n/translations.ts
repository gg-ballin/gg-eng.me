...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    freelance: {
      ...
      heading: 'freelance',
      intro: 'Proyectos entregados como contractor independiente. Contenido pensado para perfiles en Upwork, Fiverr y clientes directos.',
      portfolioNote: 'Mock data — copy en revisión',
      detail: 'detalle',
      viewDetail: 'detalle',
      backToFreelance: 'Volver a freelance',
      backToBio: 'Volver a bio',
      bannerLabel: 'Freelance',
      bannerText: '¿Buscás trabajo freelance? Ver portfolio seleccionado',
  ...
  en: {
    ...
    freelance: {
      ...
      heading: 'freelance',
      intro: 'Projects delivered as an independent contractor. Curated for Upwork, Fiverr, and direct client outreach.',
      portfolioNote: 'Mock data — copy under review',
      detail: 'detail',
      viewDetail: 'detail',
      backToFreelance: 'Back to freelance',
      backToBio: 'Back to bio',
      bannerLabel: 'Freelance',
      bannerText: 'Looking for freelance work? See selected portfolio',
